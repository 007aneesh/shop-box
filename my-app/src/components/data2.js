      ...
      {data && (
        <div className="pt-8 flex flex-col flex-wrap justify-center lg:flex-row">
          {data.map((item, index) => (
            <div
              key={index}
              className="mx-4 my-4 flex cursor-pointer flex-col pt-4  mt-11 w-72 transform overflow-hidden rounded-lg bg-white shadow-md duration-300 hover:scale-105 hover:shadow-lg"
            >
